<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formulario_prueba.aspx.cs" Inherits="DoggyOut.Formulario_prueba" %>
<!DOCTYPE html>
                        ...
                        <fieldset>
                            ...
                            <asp:Table runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox CssClass="form-control" runat="server" ID="tbNombres" placeholder="ej. Oscar David"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox CssClass="form-control" runat="server" ID="tbApellidos" placeholder="ej. Manoatl Calixto"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                        ...
                        <fieldset>
                            ...
                            <asp:Table runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox runat="server" ID="tbUsuario" placeholder="ej. Oscar0212"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
